			...
			<div class="row">
				<div class="col-md-6">
					<div class="form_container">
						...
						<c:if test="${not empty message}">
							<div
								style="color: #155724; background-color: #d4edda; padding: 10px; border-radius: 5px; margin-bottom: 15px;">
								${message}</div>
						</c:if>

						<c:if test="${not empty error}">
							<div
								style="color: #721c24; background-color: #f8d7da; padding: 10px; border-radius: 5px; margin-bottom: 15px;">
								${error}</div>
						</c:if>
						...
						<form action="${pageContext.request.contextPath}/login"
							...
							<div>
								<input type="text" class="form-control" name="username"
									placeholder="Tên đăng nhập" value="${oldUsername}" required />
							</div>
							<div>
							...
							<div style="margin-top: 20px; text-align: center;">
								<span style="color: black;">Chưa có tài khoản? </span> <a
									href="${pageContext.request.contextPath}/register"
									style="color: #ffbe33; font-weight: bold;">Đăng ký ngay</a>
							</div>
						</form>
					</div>
				</div>
...
>>>>>>> Stashed changes
        ...
        <div class="col-md-6">
          <div class="map_container">
            <img src="${pageContext.request.contextPath}/assets/images/homepage_img/o1.jpg" style="width: 100%; border-radius: 10px;" alt="">
          </div>
        </div>
      </div>
    </div>
