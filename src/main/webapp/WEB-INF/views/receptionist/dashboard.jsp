...
<body class="g-sidenav-show bg-gray-200">
      ...
      <div class="row">
          ...
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                ...
                <h4 class="mb-0">15,500,000 đ</h4>
              </div>
            </div>
            <hr class="dark horizontal my-0">
            <div class="card-footer p-3">
              <p class="mb-0"><span class="text-success text-sm font-weight-bolder">+15% </span>so với hôm qua</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            ...
            <hr class="dark horizontal my-0">
            <div class="card-footer p-3">
              <p class="mb-0"><span class="text-success text-sm font-weight-bolder">+3 </span>khách check-in mới</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            ...
            <hr class="dark horizontal my-0">
            <div class="card-footer p-3">
              <p class="mb-0"><span class="text-danger text-sm font-weight-bolder">Cần xử lý ngay</span></p>
            </div>
          </div>
        </div>
        ...
        <div class="col-xl-3 col-sm-6">
          <div class="card">
            ...
            <hr class="dark horizontal my-0">
            <div class="card-footer p-3">
              <p class="mb-0"><span class="text-success text-sm font-weight-bolder">Sẵn sàng </span>đón khách</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row mt-4">
        <div class="col-lg-6 col-md-6 mt-4 mb-4">
          <div class="card z-index-2 ">
            ...
            <div class="card-body">
              <h6 class="mb-0 ">Lượt khách trong tuần</h6>
              <p class="text-sm ">Phân bổ lượt đặt phòng theo ngày</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-6 col-md-6 mt-4 mb-4">
          <div class="card z-index-2  ">
            ...
            <div class="card-body">
              ...
              <p class="text-sm "> (<span class="font-weight-bolder">+15%</span>) tăng trưởng so với tháng trước. </p>
            </div>
          </div>
        </div>
      </div>
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div>
                            <img src="${pageContext.request.contextPath}/assets/images/dashboard_img/team-2.jpg" class="avatar avatar-sm me-3" alt="user">
                          </div>
                      ...
                      <td class="align-middle text-center text-sm">
                        <span class="text-xs font-weight-bold"> 1,500,000 đ </span>
                      </td>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div>
                            <img src="${pageContext.request.contextPath}/assets/images/dashboard_img/team-4.jpg" class="avatar avatar-sm me-3" alt="user">
                          </div>
                          <div class="d-flex flex-column justify-content-center">
                      ...
                      <td class="align-middle text-center text-sm">
                        <span class="text-xs font-weight-bold"> 4,200,000 đ </span>
                      </td>
                      <td class="align-middle text-center">
              ...
              <div class="timeline timeline-one-side">
                ...
                <div class="timeline-block mb-3">
                  ...
                  <div class="timeline-content">
                    <h6 class="text-dark text-sm font-weight-bold mb-0">Khách Nguyễn Văn A nhận phòng 101</h6>
                    <p class="text-secondary font-weight-bold text-xs mt-1 mb-0">Hôm nay 14:20</p>
                  </div>
                </div>
                ...
                <div class="timeline-block mb-3">
                  ...
                  <div class="timeline-content">
                    <h6 class="text-dark text-sm font-weight-bold mb-0">Đơn đặt mới #1024 từ Web</h6>
                    <p class="text-secondary font-weight-bold text-xs mt-1 mb-0">Hôm nay 11:00</p>
                  </div>
                </div>
                ...
                <div class="timeline-block">
                  ...
                  <div class="timeline-content">
                    <h6 class="text-dark text-sm font-weight-bold mb-0">Khách Lê Văn C trả phòng 302</h6>
                    <p class="text-secondary font-weight-bold text-xs mt-1 mb-0">Hôm nay 09:30</p>
                  </div>
                </div>
  ...
  <script src="${pageContext.request.contextPath}/assets/js/dashboard_js/plugins/chartjs.min.js"></script>
  ...
  <script>
    ...
    new Chart(ctx, {
      ...
      options: {
        ...
        scales: {
          y: { grid: { display: true, color: 'rgba(255, 255, 255, .2)' }, ticks: { color: "#fff" } },
    ...
    new Chart(ctx2, {
      ...
      options: {
        ...
        plugins: { legend: { display: false } },
        scales: {
          y: { grid: { display: true, color: 'rgba(255, 255, 255, .2)' }, ticks: { color: '#f8f9fa' } },
          x: { grid: { display: false }, ticks: { color: '#f8f9fa' } }
        },
      },
    });
